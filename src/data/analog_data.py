...
def build_enhertu_analog() -> DrugProgram:
    ...
    milestones = [
        ...
        Milestone(
            ...
            "T-DXd recommended as new standard 2L therapy for HER2+ mBC. Living Guideline format launched 11 May 2023.",
        ...
        Milestone(
            ...
            "SSN reimbursement effective 4 Jul 2023. ~5 months post-EMA — faster than typical due to innovative drug status.",
        ...
        Milestone(
            ...
            "SNS prescription available ~Dec 2022. Based on earlier EMA type II variation (Mar 2022), not Jan 2023 broadened indication.",
...
def build_trodelvy_3l_analog() -> DrugProgram:
    ...
    milestones = [
        ...
        Milestone(
            ...
            "SSN reimbursement effective 10 Aug 2022. Access via Fund for Innovative Drugs. ~9 months post-EMA.",
